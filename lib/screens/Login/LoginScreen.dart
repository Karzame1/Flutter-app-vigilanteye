          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: [
                      Image.asset(vigilanteyeLogoImg,height: 60,width: 88),
                      Image.asset(vigilanteyeNameImg,height: 50,width: 200,color:appStore.isDarkModeOn? white: black,),
                      // Text(
                      //   mainAppName,
                      //   style: boldTextStyle(size: 25, weight: FontWeight.bold, ),
                      // ),
                  10.height,
                  Padding(
                                      ...
                                      if (_loginStore.canLogin) {
                                        ...
                                        if (!result.isEmptyOrNull) {
                                          if (result.toLowerCase() ==
                                              'active') {
                                            if (!mounted) return;
                                            //Navigator.push(context, MaterialPageRoute(builder: (context)=> DeviceVerificationScreen()));
              ...
              Column(
                children: [
                  50.height,
                  Text(language!.lblByLoggingInYouAreAgreedToThePrivacyPolicy,textAlign: TextAlign.center,),
                  Padding(
